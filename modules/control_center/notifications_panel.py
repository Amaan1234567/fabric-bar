...
NOTIFICATION_IMAGE_SIZE = 40
NOTIFICATION_BUTTONS_WRAP_THRESHOLD = 2
class NotificationItem(Box):
    def __init__(self,notification: Notification,**kwargs):
        super().__init__(orientation='horizontal',h_align='fill',style_classes=['control-center-notification-item'])
