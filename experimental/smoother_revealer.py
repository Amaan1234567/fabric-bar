    ...
    def __init__(self):
        ...
        self.revealer = HackedRevealer(
            child=Label(
                ...
                style="margin: 10px;background: cyan; border-radius: 5px; padding: 20px;",
            ),
        )

        # 2. Create a Toggle Button
        self.toggle_btn = Button(label="Toggle Reveal", on_clicked=self.on_toggle)
        ...
        self.box = Box(
            ...
            spacing=10,
            style="padding: 20px;",
            children=[self.toggle_btn, self.revealer],
        )
